      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          ...
          <div class="carousel-caption">
              ...
              <br> <br>
             <a href="contact.php"><button class="button"> GET STARTED <img src="images/icon-button.png" class="icon-button"> </button></a>
    ...
    <section class="section_services">
        <div class="container">
            	<div class="col-md-6">
                    ...
                    MobiWhiz believes in changing the system, thinking outside the box and breaking the norms for maximum impact, and that’s what makes us THE APP WIZARDS.</P>
              </div>
