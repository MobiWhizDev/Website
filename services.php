<?php include_once('includes/header.php'); ?>
    <div class="services">
        ...
        <section class="section_servey">
            <div class="container">
                <div class="col-md-6">
                    ...
                    <br>
                    <p>From iPhone to iPad to Apple Watch, we create world class mobile apps and have achieved success in almost every industry. We have certified team in Objective C, Database experts, and Native architecture design experts that will develop the best mobile app for your brand</p>
                    <div class="col-lg-4">
                        <ul>
                            <li>iPHONE APPS</li>
                            <li>APPLE WATCH</li>
                    ...
                    <div class="col-lg-4 service-list2">
                        <ul>
                            <li>iPAD APPS</li>
                            <li>DESKTOP APP</li>
                        </ul>
        ...
        <section class="section_servey anroid anroid2">
            <div class="container">
                <div class="col-md-6">
                    <img src="images/anroid-mobile.png" class="img-desktop">
                </div>
                <div class="col-md-6">
                    <br>
                    <br>
                    ...
                    <br>
                    <p>We’ve developed hundreds of cool Android apps on releases from 2.X to 5.X. From Gingerbread to Lollipop, simple phones to custom devices to Android wearables — we’ve done it all.</p>
                    <div class="col-lg-4">
                        <ul>
                            <li>ANDROID PHONES</li>
                            <li>ANDROID WEARABLES</li>
                        </ul>
                    </div>
                    <div class="col-lg-4 service-list2">
                        <ul>
        ...
        <section class="section_servey game">
            <div class="container">
                <div class="col-md-6">
                    ...
                    <br>
                    <p>The quality of game design ultimately depends on creativity and vision. From 2D Game apps to 3D Complex Games, Our team using Unity3D knows how to deliver high quality performance driven games that users are addicted.</p>
                    <div class="col-lg-4">
                        <ul>
