...
function formSubmit(form) {
    ...
    return $("#dialog_submit").html("<img src='images/loading.gif' />"), $("#modaltrigger").click(), $.post("rest.php", $data, function(t) {
        ...
        t = $.trim(t), $("#dialog_submit").html("-1" == t || "" == t ? "Error while connecting to server" : "Thank you for your inquiry. Your details have been forwarded to one of our app wizards who will get in touch with you shortly.<br/> <p>Ph: +1-267-933-0030 |Email: info@mobiwhiz.com</p>"), $("#modaltrigger").click();
