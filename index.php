    ...
    <section class="section_approach">
        <div class="container">
            ...
            <div class="col-lg-6">
                ...
                <br>
                <a href="" class="text-deactive">Design is something very close to our heart. Our app designers value customer experience the most in any app design and every design wireframe we built is kept in view rich user experience.
                </a>
                </span>
                </div>
                <div class="wrap">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                        ...
                        <div class="value-box yellow2">
                            <div class="value-image"> <img src="images/icon-team.png" alt="team">
                                ...
                                <p>You will get to know your team very well. When we start a project, we assemble a team of mobile app designers and certified app developers based on your needs, and they stay on your project till the job is completed.</p>
                            </div>
                        </div>
                        <!--value-box-->
                        ...
                        <div class="value-box light-blue2">
                            <div class="value-image"> <img src="images/icon-design.png" alt="centric">
                                ...
                                <p>The only WOW factor that makes your customer use your app for the first time is the rich design experience that our mobile app designers bring in the app.</p>
                            </div>
                        </div>
                        <!--value-box-->
